...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
    ...
    ChatBot _newChatBotI("../images/chatbot.png");
    _newChatBotI.SetChatLogicHandle(this);
    _newChatBotI.SetRootNode(rootNode);
    rootNode->MoveChatbotHere(std::move(_newChatBotI));
